...
function mapSubscriptionStatus(lsStatus: string): 'active' | 'trialing' | 'paused' | 'past_due' | 'canceled' {
    const statusMap: Record<string, 'active' | 'trialing' | 'paused' | 'past_due' | 'canceled'> = {
        on_trial: 'trialing',
        active: 'active',
        paused: 'paused',
        past_due: 'past_due',
